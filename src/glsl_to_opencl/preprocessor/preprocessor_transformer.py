...
class PreprocessorTransformer:
    ...
    Conditional directives (#if, #ifdef, etc.) pass through unchanged.
    """
    ...
    def _transform_line(self, line: str) -> str:
        ...
        if not stripped.startswith('#'):
            # Not a preprocessor directive, return unchanged
            return line
    ...
    def _transform_macro_body(self, body: str) -> str:
        ...
        Applies:
        1. Float literal suffix: 3.14159 -> 3.14159f
        2. Function call prefix: sin(x) -> GLSL_sin(x)
        ...
        # Step 1: Transform float literals
        ...
        # Step 2: Transform GLSL function calls
